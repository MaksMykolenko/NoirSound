...
export default function GenrePill({ genre, label, active, onClick, children }) {
  return (
    <button
      onClick={onClick}
      aria-pressed={active}
      className={`inline-flex min-h-10 shrink-0 cursor-pointer items-center gap-1.5 whitespace-nowrap rounded border px-3.5 py-2 text-sm font-medium transition-colors duration-150 ${
        active
